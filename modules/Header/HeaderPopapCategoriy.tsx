      ...
      <div className="w-[30%] flex flex-col py-[43px] px-[32px] bg-[#EBEFF3]">
        {isLoading || isError ? (
          ...
          categories?.map((item: HeaderBottomType) => (
            <Link key={item.id} className="py-[12px] flex items-center gap-[15px] pl-[40px] mt-[5px] text-[16px] hover:bg-white hover:text-black" href={`/pages/products?category=${item.id}`}>
